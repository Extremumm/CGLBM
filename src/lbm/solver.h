...
private:
    ...
    bool dynamic_mixing_;       ///< config_.viscosity_mixing == ViscosityMixing::Dynamic
    ...
    Field stress_xx_;      ///< capillary stress, xx, for SurfaceTension::CapillaryStress
    Field stress_xy_;      ///< capillary stress, xy
    Field stress_yy_;      ///< capillary stress, yy
